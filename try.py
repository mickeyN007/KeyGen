class KeyGen():
    ...
    def split(self):
        ...
        listA = (parityDrop[0:28])
        listB = (parityDrop[28:56])
        ...
        NewlistA = list(listA)
        NewlistB = list(listB)
        #counter = (i for i in range (1, 16))
        #for i in counter:
        NewlistA += [NewlistA.pop(0)]
        NewlistB += [NewlistB.pop(0)]
        print("NewA",i, NewlistA)
        print("NewB",i, NewlistB)
